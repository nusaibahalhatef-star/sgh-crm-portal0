...
- [ ] إضافة حقل العمر
- [ ] إضافة dropdown للإجراءات (من procedures الطبيب)
- [ ] جعل البريد الإلكتروني اختياري
- [ ] إضافة مربع ملاحظات إضافية
- [ ] تحديث validation

#### المرحلة 4: تحسين إدارة الحجوزات في لوحة التحكم
- [ ] إضافة إمكانية تعديل معلومات المريض
- [ ] إضافة حقل ملاحظات الموظف
- [ ] تحسين تغيير حالة الحجز
- [ ] عرض جميع الحقول الجديدة

#### المرحلة 5: قسم الأطباء الزائرين
- [ ] إضافة checkbox "طبيب زائر" في نموذج إضافة/تعديل طبيب
- [ ] إنشاء صفحة VisitingDoctorsPage
- [ ] إضافة route في App.tsx
- [ ] إضافة link في Navbar
- [ ] فلترة الأطباء الزائرين في الصفحة الجديدة
