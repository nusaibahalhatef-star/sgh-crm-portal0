...
- [ ] إضافة ميزة "عرض المزيد" للعروض المجانية في صفحة المخيم
- [ ] إضافة ميزة "عرض المزيد" للعروض المخفضة في صفحة المخيم
- [ ] تحسين نموذج التسجيل للمخيم - إضافة زر اختيار الإجراء
