...
### إصلاح عرض النص العربي في تصدير PDF ✅ مكتمل
- [x] استبدال jsPDF بـ html2pdf.js لدعم العربية بشكل كامل
- [x] إعادة كتابة advancedExport.ts لاستخدام HTML مع دعم RTL
- [x] إضافة تنسيق كامل للترويسة والذييل بالعربية
- [x] اختبار التصدير والتأكد من ظهور النص بشكل صحيح

### إصلاح خطأ تجميد الصفحة عند تصدير PDF ✅ مكتمل
- [x] إضافة loading state مع toast.loading أثناء عملية التصدير
- [x] تحسين error handling مع رسائل خطأ واضحة عبر toast
- [x] تحسين أداء html2pdf بتقليل scale إلى 1.5 وتحسين الخيارات
- [x] إضافة timeout 60 ثانية للعملية لمنع التجميد الطويل
- [x] تحسين إدارة العناصر المؤقتة وإزالتها بعد التصدير
